...
function addSuite(source: TemplateSource | undefined): void {
    suite(`Template Count - ${source === undefined ? 'defaultOnExtensionActivation' : source}`, () => {
        const cases: TestCase[] = [
            ...
            { language: ProjectLanguage.JavaScript, version: FuncVersion.v4, expectedCount: 19 },
            ...
            { language: ProjectLanguage.TypeScript, version: FuncVersion.v4, expectedCount: 19 },
